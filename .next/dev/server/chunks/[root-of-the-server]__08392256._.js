...
async function POST(req) {
    try {
        ...
        if (!url || !/^https?:\/\//i.test(url)) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'invalid url'
        }, {
            status: 400
        });
        ...
        if (err?.name === 'AbortError') return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'fetch timeout'
        }, {
            status: 504
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__08392256._.js.map