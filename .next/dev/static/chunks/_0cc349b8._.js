...
_s(PostsProvider, "QK1OZ1h5716X2huuAfW1ZfwNqek=");
_c = PostsProvider;
function usePosts() {
    _s1();
...
function PostDetailsDrawer() {
    ...
    const unsaved = Object.keys(local).some((k)=>{
        // @ts-ignore
...
_s(PostDetailsDrawer, "0RCTSk5IjR2ITJ9QoPYDYgLLuj0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$PostsProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePosts"]
    ];
});
...
//# sourceMappingURL=_0cc349b8._.js.map