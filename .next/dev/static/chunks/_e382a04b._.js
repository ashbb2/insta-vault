...
"[project]/lib/repos/localStorageRepo.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function loadAll() {
    ...
    return {
        posts: __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$data$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["posts"],
        categories: __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$data$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["categories"],
        collections: __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$data$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collections"]
    };
}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$data$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/data/mockData.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$repos$2f$localStorageRepo$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/repos/localStorageRepo.ts [app-client] (ecmascript)");
;
...
function PostsProvider({ children }) {
    ...
    const cloudSyncEnabled = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_ENABLE_CLOUD_SYNC === '1';
        ...
        "PostsProvider.useEffect": ()=>{
            ...
            async function hydrate() {
                try {
                    ...
                    const saved = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$repos$2f$localStorageRepo$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["localRepo"].loadAll();
                    if (saved && !cancelled) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PostsProvider.useEffect": ()=>{
            ...
            const timer = window.setTimeout({
                "PostsProvider.useEffect.timer": async ()=>{
                    try {
                        if (cloudSyncEnabled) {
                            const response = await fetch('/api/state', {
                                method: 'PUT',
                        ...
                        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$repos$2f$localStorageRepo$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["localRepo"].saveAll({
                            posts,
                            categories,
                            collections
                        });
            ...
            }["PostsProvider.useEffect.timer"], 450);
            return ({
                "PostsProvider.useEffect": ()=>{
    ...
    const filteredPosts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PostsProvider.useMemo[filteredPosts]": ()=>{
            ...
            const categoryNameById = new Map(categories.map({
                "PostsProvider.useMemo[filteredPosts]": (category)=>[
                        category.id,
                        category.name.toLowerCase()
                    ]
            }["PostsProvider.useMemo[filteredPosts]"]));
            const collectionNameById = new Map(collections.map({
                "PostsProvider.useMemo[filteredPosts]": (collection)=>[
                        collection.id,
            ...
            let res = posts.filter({
                "PostsProvider.useMemo[filteredPosts].res": (p)=>{
                    ...
                    const collectionNames = p.collectionIds.map({
                        "PostsProvider.useMemo[filteredPosts].res.collectionNames": (id)=>collectionNameById.get(id) ?? ''
                    }["PostsProvider.useMemo[filteredPosts].res.collectionNames"]).join(' ');
...
_s(PostsProvider, "r78T8gmxyBGf+jKkqR7/6Fn/D6U=");
_c = PostsProvider;
function usePosts() {
    _s1();
...
function TopBar({ sidebarOpen, setSidebarOpen, onOpenAdd }) {
    ...
    const { searchText, setSearchText, sortOption, setSortOption, activeCategoryId, activeCollectionId } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$PostsProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePosts"])();
...
_s(TopBar, "DECdE8MAvmDPP4L7EWLtMprqiy0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$PostsProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePosts"]
    ];
});
...
function AddPostModal({ open, onClose, onImported }) {
    _s();
    const [mode, setMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('import');
    ...
    const { addPost, categories, collections } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$PostsProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePosts"])();
    ...
    const [categoryId, setCategoryId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('c-unsorted');
    const [selectedCollections, setSelectedCollections] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [tagsText, setTagsText] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    if (!open) return null;
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    mode === 'import' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: collections.map((col)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                type: "button",
...
_s(AddPostModal, "WzK0sUtPAmCcdq6xX+KPodYOHpk=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$PostsProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePosts"]
    ];
});
...
function BottomNav({ openAdd }) {
    _s();
    const { setActiveCategory, setActiveCollection, activeCategoryId, activeCollectionId } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$PostsProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePosts"])();
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
...
_s(BottomNav, "K0s9pK4PXANsXVlwCDkEShQ8g3I=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$PostsProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePosts"]
    ];
});
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$SidebarNav$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/SidebarNav.tsx [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$PostsProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/PostsProvider.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$PostDetailsDrawer$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/PostDetailsDrawer.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function AppShell({ children }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$PostsProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PostsProvider"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("aside", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$SidebarNav$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                                    fileName: "[project]/components/AppShell.tsx",
                                    lineNumber: 23,
                                    columnNumber: 13
                                }, this)
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$PostDetailsDrawer$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                        fileName: "[project]/components/AppShell.tsx",
                        lineNumber: 49,
                        columnNumber: 9
                    }, this),
...
_s(AppShell, "zhM5DU6gCr1Zmm+w+BZ7IQGP3n8=");
_c = AppShell;
var _c;
...
//# sourceMappingURL=_e382a04b._.js.map